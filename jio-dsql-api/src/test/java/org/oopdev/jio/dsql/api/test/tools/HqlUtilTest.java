...
public class HqlUtilTest {
     ...
     * @return
     */
    public static String selectForListByProjection(CriteriaParent criteria, Projection projection, String alias, TransformerUtilTest.Elements elements, StringJoiner groupJoiner){
        String result;
