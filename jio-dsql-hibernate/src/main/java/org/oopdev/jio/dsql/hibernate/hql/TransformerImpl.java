...
import org.oopdev.jio.dsql.hibernate.hql.transformers.AliasToBeanResultTransformer;
import org.oopdev.jio.dsql.hibernate.hql.transformers.AliasToEntityMapResultTransformer;
...
public class TransformerImpl<E> extends Transformer<E> {
    ...
    public TransformerImpl(Session session, MetaFinder finder) {
        this(session, null, finder);
    }

    public TransformerImpl(Session session, Class<? extends E> transformClass, MetaFinder finder) {
